...
static const char START_SVO_RECORDING[] = "zed_wrapper/start_svo_recording";
  ...
  class start_svo_recordingRequest : public ros::Msg
  {
    ...
    const char * getType(){ return START_SVO_RECORDING; };
    const char * getMD5(){ return "d53367c1321809b5cdba020b6f0085ff"; };
