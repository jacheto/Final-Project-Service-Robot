#ifndef _ROS_SERVICE_set_initial_pose_h
#define _ROS_SERVICE_set_initial_pose_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SET_INITIAL_POSE[] = "zed_wrapper/set_initial_pose";

  class set_initial_poseRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SET_INITIAL_POSE; };
    const char * getMD5(){ return "2d76cb67dcd5839567c5ce0b111a67e4"; };

  };

  class set_initial_poseResponse : public ros::Msg
  {
    public:
      typedef bool _done_type;
      _done_type done;

    set_initial_poseResponse():
      done(0)
    {
    }
