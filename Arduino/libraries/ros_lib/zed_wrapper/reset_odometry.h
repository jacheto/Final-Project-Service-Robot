...
static const char RESET_ODOMETRY[] = "zed_wrapper/reset_odometry";
  ...
  class reset_odometryRequest : public ros::Msg
  {
    ...
    const char * getType(){ return RESET_ODOMETRY; };
  ...
  class reset_odometryResponse : public ros::Msg
  {
    ...
    const char * getType(){ return RESET_ODOMETRY; };
    const char * getMD5(){ return "e1e87fc9e9e6c154eca93b9fa292cc05"; };
