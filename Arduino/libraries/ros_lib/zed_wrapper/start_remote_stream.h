...
static const char START_REMOTE_STREAM[] = "zed_wrapper/start_remote_stream";
  ...
  class start_remote_streamRequest : public ros::Msg
  {
    ...
    const char * getType(){ return START_REMOTE_STREAM; };
    const char * getMD5(){ return "a6f55a6077162992b395e1b483a03367"; };
