...
static const char SET_LED_STATUS[] = "zed_wrapper/set_led_status";
  ...
  class set_led_statusRequest : public ros::Msg
  {
    ...
    const char * getType(){ return SET_LED_STATUS; };
    const char * getMD5(){ return "f2e0f7cf20d5f300d5382e9eab56e737"; };
